...
namespace FysioDanmark_Project_Website
{
    ...
    {
        public static void WriteToJsonBook(List<Models.Services> books, string JsonFileName)
        {
            string output = Newtonsoft.Json.JsonConvert.SerializeObject(books, Newtonsoft.Json.Formatting.Indented);
            File.WriteAllText(JsonFileName, output);
        }
        
        public static void WriteToJsonOrder(List<Bookings> orders, string JsonFileName)
        {
